...
Известно, что электричка "Москва-Петушки" аварийно останавливается раз в несколько дней.
...
**Требуется**:
1. Ввести предположение, каким распределение описывается данная выборка.
2. Записать задачу формально.
...
## Задача 4.3
Правительство Москвы испытвает систему обнаружения преступников по камерам в метро. В качестве демонстрации работоспособности системы была поставлена цель: найти и задержать опасного рецидивиста по кличке Капитан Зеленый. Была собрана выборка из 5000 снимков лица, для которых была проверена гипотеза о несовпадении этого снимка с лицом Зеленого. Для 100 фотографий нулевая гипотеза была отвергнута на уровне значимости alpha = 0.05.

**Требуется:**
1. Определить, в чем недостаток данного подхода и как можно его улучшить?
2. Предложить наилучший, на ваш взгляд, способ для повышения качества данного решения. Какую меру качества контролирует данный метод? Какие гарантии
он предоставляет? В чём недостатки данного метода? (нисходящий/восходящий/одношаговый?
в чём смысл?)
3. Как изменилась мощность при использовании предложенного вами метода относительно изначальной процедуры проверки?
4. Известно, что все 5000 фотографий были сделаны для разных людей. Ответьте на те же вопросы из пункта 2.
5. Как изменилась мощность при использовании предложенного вами метода относительно предыдущего метода?
